...
func (self *dbBackend) clear_locks(worker_name string) error {
	var e error
...
func (self *dbBackend) reserve(w *worker) (*Job, error) {
	...
	buffer.WriteString(" priority ASC, run_at ASC")
...
func (self *dbBackend) create(job *Job) error {
	...
	//1         2         3        4           NULL        5       NULL       NULL       NULL       6           7
	//priority, attempts, handler, handler_id, last_error, run_at, locked_at, locked_by, failed_at, created_at, updated_at
	if self.isNumericParams {
		_, e = self.db.Exec("INSERT INTO tpt_delayed_jobs(priority, attempts, queue, handler, handler_id, last_error, run_at, locked_at, locked_by, failed_at, created_at, updated_at VALUES($1, $2, $3, $4, NULL, $5, NULL, NULL, NULL, $6, $7)",
